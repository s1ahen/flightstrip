...
const firebaseConfig = {
  ...
  function createFlightStrip() {
      ...
      const stripData = {
          callsign: document.querySelector('[placeholder="CALLSIGN"]').value || "N/A",
          type: document.querySelector('[placeholder="TYPE"]').value || "N/A",
          dep: document.querySelector('[placeholder="DEP"]').value || "N/A",
          arr: document.querySelector('[placeholder="ARR"]').value || "N/A",
          flt: document.querySelector('[placeholder="FLT"]').value || "N/A",
          fltplan: document.querySelector('[placeholder="FLTPLN"]').value || "N/A",
          notes: document.querySelector('[placeholder="Notes"]').value || "N/A",
          clearance: document.querySelector('#clearance').value || "pending",
